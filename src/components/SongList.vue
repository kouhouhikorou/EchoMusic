...
<template>
  <div v-if="songs.length === 0" class="flex flex-col items-center justify-center py-16 text-[#ccc] gap-2">
  ...
  <div v-else>
    <div
      ...
      class="flex items-center gap-3 px-4 py-2.5 cursor-pointer transition-colors hover:bg-[#f5f5f5] group"
