...
<template>
  <Teleport to="body">
    <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div class="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl border border-[#eee] mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <h2 class="text-center text-xl font-bold mb-5 text-[var(--color-text)]">使用须知与免责声明</h2>
        <div class="space-y-3 text-sm text-[var(--color-text)] opacity-68 mb-6 leading-relaxed">
        ...
        <label class="flex items-center gap-2 text-sm opacity-58 cursor-pointer mb-5">
