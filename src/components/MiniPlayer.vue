...
import { Play, Pause, PlaySkipForward, PlaySkipBack, Heart, HeartOutline, ListOutline } from '@vicons/ionicons5'
  ...
  >
    ...
    <div class="flex items-center gap-3 px-3 py-2">
      ...
      <div class="flex items-center gap-2">
        <button class="min-h-[36px] min-w-[36px] flex items-center justify-center text-[#999] hover:text-[#ec4141] transition-colors" @click.stop="toggleLike">
